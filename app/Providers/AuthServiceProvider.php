...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function registerPostPolicies($gate)
    {
        ...
        $dropping =["cari_d","lihat_tt_d","masuk_tt_d","setuju_tt_d","lihat_st_d","masuk_st_d","setuju_st_d","lihat_p_d",
                    "masuk_p_d","setuju_p_d","setuju_p2_d","notif_setuju_tt_d","notif_setuju_st_d","notif_setuju_p_d",
                    "notif_setuju_p2_d","notif_ubah_tt_d","notif_ubah_st_d","notif_ubah_p_d"] ;
        ...
        $transaksi = ["menu_transaksi","tambah_t","info_t","cari_t","tambah_item_t","ubah_item_t","hapus_item_t","berkas_t",
                    "simpan_t","ajukan_t","setuju_t","setuju2_t","tanggal","notif_setuju_t","notif_setuju2_t",
        ...
        $anggaran = ["info_a","cari_a","batas_a","tambah_a","tambah_item_a","ubah_item_a","hapus_item_a",
                    ...
                    "notif_setuju_iia","notif_setuju_iiia","notif_setuju_iva","notif_setuju_va",
                    "notif_setuju_via","notif_setuju_viia","notif_setuju_viiia","notif_setuju_ixa",
                    "notif_ubah_a","notif_pengajuan_anggaran","semua_a"];
