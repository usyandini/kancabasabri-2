                            ...
                            <div class="card-block ">
                              <form method="POST" action="">
                                <div class="row">
                                  ...
                                  <div class="col-xs-4">
                                    <div class="form-group">
                                      ...
                                      <input id="cari_keyword" name="cari_keyword" class="form-control" placeholder="Kata Kunci...">
                                    </div>
                                  </div>
                                  <div class="col-xs-2">
                                    <div class="form-group">
                                ...
                                <div class="row">
                                  <div class="col-xs-2">
                                    <div class="form-group">
                                      <div onclick="cariRiwayat()" id="cari_button" name="cari_button" class="btn btn-outline-primary"><i class="fa fa-search"></i> Cari</div>
                          ...
                          <div class="row">
                            ...
                            <div class="row col-xs-12" style="display:block">
                              ...
                              <div class="pull-right">
                                <div class="form-group">
                                  <a onclick="download_report()" class="btn btn-outline-primary"><i class="fa fa-download"></i> Unduh</a>
                                </div>
                              </div>
                            </div>
                          </div>
