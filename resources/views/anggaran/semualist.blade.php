                ...
                <div class="row">
                  <div class="col-xs-12">
                    <div class="card">
                      ...
                      <div class="card-body collapse in">
                        <div class="card-block">
                          <form enctype="multipart/form-data" role="form" action="{{ URL('anggaran/semua/cari') }}" method="GET" >
                                <div class="row">
                            {{ csrf_field() }}
                              <div class="col-xs-3">
                                <div class="form-group">
                                <label>Tahun</label><br>
                                <select class="select2 form-control block" name="tahun" id="tahun" onchange="changeUnit()" required="required">
                              ...
                              <div class="col-xs-4">
                                <div class="form-grpup">
                                  ...
                                  <select class="select2 form-control block" name="persetujuan" required="required"></select>
                                </div>
                              </div>
                            </div>
                            <div class="row">
                    ...
                    <script type="text/javascript">
                          function changeUnit(){
                            var tahun = $('#tahun').val();
                                  var uri = "{{ url('anggaran/myform').'/'}}"+tahun;
