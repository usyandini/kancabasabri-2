            ...
            <div class="content-header row">
              <div class="content-header-left col-md-6 col-xs-12 mb-2">
                <h3 class="content-header-title mb-0">Verifikasi Penyesuaian Level 1</h3>
                  ...
                  <div class="col-xs-12">
                    <div class="card">
                      <div class="card-header">
                        <h4 class="card-title">Daftar Penyesuaian Transaksi Level 1</h4>
                              ...
                              <table class="table table-striped table-bordered datatable-select-inputs nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td><center>
                                          <a href="{{ URL('dropping/verifikasi/penyesuaian/'. $b->id) }}" target="_blank" class="btn btn-success btn-sm"><i class="fa fa-eye"></i> Lihat</a>
                                   </center></td>
                                  </tr>
