            			...
            			<div class="col-xs-12">
            				<div class="card">
            					<div class="card-header">
            						<h4 class="card-title">Daftar Penarikan Setor Tunai</h4>
            									...
            									<table class="table table-striped table-bordered datatable-select-inputs nowrap" cellspacing="0" width="100%">
            										...
            										<tbody>
            											...
            											<tr>
            												...
            												<td><center>
                                                                                          <a href="{{ URL('/dropping/verifikasi/setortunai/'. $b->id) }}" target="_blank" class="btn btn-success btn-sm"><i class="fa fa-eye"></i> Lihat</a>
