        ...
        <div data-scroll-to-active="true" class="main-menu menu-fixed menu-light menu-accordion menu-shadow">
            <div class="main-menu-content" style="margin-top:45px;">
                <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
                    ...
                    <ul class="menu-content">
                        @can('manajemen_i_t')
                        <li class="is-shown {{ checkActiveMenu('item') }}"><a href="{{ url('/item', $parameters = [], $secure = null) }}" class="menu-item">Manajemen Item Transaksi</a></li>
                        @endcan
                        @can('manajemen_i_a')
                        <li class="is-shown {{ checkActiveMenu('item') }}"><a href="{{ url('/item', $parameters = [], $secure = null) }}" class="menu-item">Manajemen Item Anggaran</a></li>
                        @endcan
                        @can('manajemen_i')
                        <li class="is-shown {{ checkActiveMenu('item/anggaran') }}"><a href="{{ url('/item/anggaran', $parameters = [], $secure = null) }}" class="menu-item">Manajemen Item</a>
                        @endcan
                        @can('manajemen_a_m')
