                        ...
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-xs-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="{{ url('/arahan_rups') }}">Manajemen Arahan RUPS</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
			            ...
			            <div class="col-xs-12">
			              <div class="card">
			                <div class="card-header">
			                  <h4 class="card-title">Daftar Arahan RUPS</h4></br>
			                  <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
			                  <div class="card-body collapse in">			                
			                  	<div class="card-block">
			                  	<span><a class="btn btn-success" data-target="#tambah" data-toggle="modal"><i class="fa fa-plus"></i> <b>Tambah Arahan RUPS</b></a></span>
