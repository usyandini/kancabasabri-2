                ...
                @section('content')
               	<div class="content-header row">
                    <div class="content-header-left col-md-6 col-xs-12 mb-2">
                        <h3 class="content-header-title mb-0">Tambah Item Anggaran</h3>
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-xs-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ url('/') }}">Manajemen Item</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ url('/') }}">Master Item Anggaran</a>
                                    </li>
                                    <li class="breadcrumb-item active"><a href="{{ url('/item/tambah/anggaran') }}">Tambah Item Anggaran</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="card">
                          <div class="card-header">
                            <h4 class="card-title" id="basic-layout-card-center">Data Item Anggaran</h4>
                            ...
                            <div class="card-block">
                              ...
                              <div class="form-body">
                                  ...
                                  <div = "row">
                                    <div class = "col-md-10">
                                      <select class="select2 form-control" name="jenis" id="jenis" required>
                                        ...
                                        @foreach($jenis as $ja)
                                        <option {{ $items->jenis == $ja->kode ? 'selected=""' : '' }} value="{{ $ja->kode }}">{{ $ja->kode }} - {{ $ja->name }}</option>
                                        @endforeach
                                      </select>
                                    </div>
	                                  <div class = "col-md-2">
                                ...
                                <div class="form-group col-md-5">
                                  <label for="jenis">Sub Pos</label>
                                  <div = "row">
                                    <div class = "col-md-12">
                                      <select class="select2 form-control" name="subpos" id="subpos" required>
                                  ...
                                  <div = "row">
                                    <div class = "col-md-10">
                                      <select class="select2 form-control" id="kelompok" name="kelompok" required>
                                        ...
                                        <option {{ $items->kelompok == $ka->kode ? 'selected=""' : '' }} value="{{ $ka->kode }}">{{ $ka->kode }} - {{ $ka->name }}</option>
                                        @endforeach
                                      </select>
                                    </div>
                                    <div class = "col-md-2">
                                ...
                                <div class="form-group col-md-5">
                                  <label for="jenis">Mata Anggaran</label>
                                  <div = "row">
                                    <div class = "col-md-12">
                                      <select class="select2 form-control" name="kegiatan" id="kegiatan" required>
                          ...
                          <div class="card-body">
                            <div class="card-block">
                              <div class="form-actions right">
                                <a href="{{ url('item/list/anggaran') }}" class="btn btn-warning mr-1">
