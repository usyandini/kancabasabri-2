			                ...
			                <div class="card-header">
			                  ...
			                  <div class="card-body collapse in">			                
                                ...
                                <input type="hidden" name="id" value="{{$bb->id}}" />
			                  	<tr><td><b> Verifikasi </b></td><td><b> : </b></td><td><select class="select form-control" name="verifikasi" style="width:400px" required="required" value="{{$bb->verifikasi}}" @if ($bb->kirim==3) disabled="disabled" @endif>
			                  	...
			                  	<tr><td></td></tr>
			                  	<tr><td><b> keterangan </b></td><td><b> : </b></td><td><textarea class="form-control" name="keterangan" rows="3" style="width:400px" placeholder="masukkan keterangan" @if ($bb->kirim==3) disabled="disabled" @endif>{{ $bb->keterangan }}</textarea></td></tr>
