                    ...
                    <div class="content-header-left col-md-12 col-xs-12 mb-2">
                        ...
                        <div class="row breadcrumbs-top">
                            <div class="breadcrumb-wrapper col-xs-12">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item active"><a href="#">Approval Pengajuan Dropping Level 2 KABID Akuntansi</a>
                                    </li>
                                </ol>
                            </div>
                        </div>
    ...
    ?></td></tr><tr><td></td></tr><tr><td></td></tr>
                                ...
                                <input type="hidden" name="id" value="{{$bb->id}}" />
			                  	...
			                  	<tr><td></td></tr>
			                  	<tr><td><b> keterangan </b></td><td><b> : </b></td><td><select class="select form-control" name="keterangan" style="width:400px" value="{{$bb->keterangan}}" @if (($bb->kirim<>3)||($bb->verifikasi!=2)) disabled="disabled" @endif>
