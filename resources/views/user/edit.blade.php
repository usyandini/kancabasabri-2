                                ...
                                <form class="form" action="{{ url('user').'/'.$user->id }}" method="POST">
                                  ...
                                  <div class="form-body">
                                    <div class="form-group">
                                      ...
                                      <input type="text" required="" class="form-control" placeholder="Username" name="username" value="{{ old('username') ? old('username') : $user->username }}">
                                    </div>
                                    <div class="form-group">
                                      <label for="eventRegInput2">Nama Lengkap</label>
                                      <input type="text" required="" class="form-control" placeholder="Nama" name="name" value="{{ old('name') ? old('name') : $user->name }}">
                                    </div>
                                    <div class="form-group">
                                      <label for="eventRegInput4">Email</label>
                                      <input type="email" required="" class="form-control" placeholder="Email" name="email" value="{{ old('email') ? old('email') : $user->email }}">
                                    </div>
                                    <div class="form-group">
                                      <label>Jadikan administrator?</label>
                                      <div class="input-group">
                                        <label class="display-inline-block custom-control custom-radio ml-1">
                                          <input type="radio" name="is_admin" class="custom-control-input" value="1" {{ $user->is_admin ? 'checked=""' : '' }}>
                                          <span class="custom-control-indicator"></span>
                                          <span class="custom-control-description ml-0">Ya</span>
                                        </label>
                                        <label class="display-inline-block custom-control custom-radio">
                                          <input type="radio" name="is_admin" class="custom-control-input" value="0" {{ $user->is_admin ? '' : 'checked=""' }}>
                                          <span class="custom-control-indicator"></span>
