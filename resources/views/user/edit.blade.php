                              ...
                              <div class="card-block">
                                  <div class="form-group">
                                    ...
                                    <select class="select2 form-control menu" name="perizinan_dropping[]" multiple="" data-placeholder="Perizinan untuk Menu Dropping">
                                      <option {{ collect($user->perizinan('dropping'))->contains("1") ? 'selected="selected"' : '' }} value="1">Staff</option>
                                      <option {{ collect($user->perizinan('dropping'))->contains("2") ? 'selected="selected"' : '' }} value="2">Approver</option>
                                      <option {{ collect($user->perizinan('dropping'))->contains("4") ? 'selected="selected"' : '' }} value="4">Superuser</option>
                                    </select>
                                  </div>
                                  <div class="form-group">
                                    ...
                                    <select class="select2 form-control menu" name="perizinan_transaksi[]" multiple="" data-placeholder="Perizinan untuk Menu Transaksi">
                                      <option {{ collect($user->perizinan('transaksi'))->contains("1") ? 'selected="selected"' : '' }} value="1">Staff</option>
                                      <option {{ collect($user->perizinan('transaksi'))->contains("2") ? 'selected="selected"' : '' }} value="2">Approver</option>
                                      <option {{ collect($user->perizinan('transaksi'))->contains("4") ? 'selected="selected"' : '' }} value="4">Superuser</option>
                                    </select>
                                  </div>
                                  <div class="form-group">
                                    ...
                                    <select class="select2 form-control menu" name="perizinan_anggaran[]" multiple="" data-placeholder="Perizinan untuk Menu Anggaran">
                                      <option {{ collect($user->perizinan('anggaran'))->contains("1") ? 'selected="selected"' : '' }} value="1">Staff</option>
                                      <option {{ collect($user->perizinan('anggaran'))->contains("2") ? 'selected="selected"' : '' }} value="2">Approver</option>
                                      <option {{ collect($user->perizinan('anggaran'))->contains("4") ? 'selected="selected"' : '' }} value="4">Superuser</option>
                                    </select>
                                  </div>
