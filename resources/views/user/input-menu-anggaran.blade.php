    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="card-block">
          ...
          <div class="form-group skin skin-square" id="anggaran">
            ...
            <ul id="info_anggaran">
                <li>
                  <fieldset>
                    <input type="checkbox" name="perizinan[manajemen_nilai_m_a]" {{ isset(old('perizinan')['manajemen_nilai_m_a']) ? 'checked=""' : '' }}>
                ...
                <li>
                  <fieldset>
                    <input type="checkbox" name="perizinan[semua_a]" {{ isset(old("perizinan")['semua_a']) ? 'checked=""' : '' }}>
        ...
        <div class="card-block">
          ...
          <div class="form-group skin skin-square" id="anggaran">
            <fieldset >
              <input type="checkbox" name="perizinan[notif_pengajuan_anggaran]" value="1">
